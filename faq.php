            ...
            <div class="container">
                <div class="accordion">
                    <div class="accordion-item" id="question1">
                        ...
                        <div class="answer">
                            <p>
                                Nachdem die Verfügbarkeit des Zimmers geprüft wurde, werden Sie gebeten, Ihre Daten in
                                unser
                                Online-Reservierungsformular einzugeben. Sobald das System Ihre Reservierung bestätigt
                                hat,
                                erhalten
                                Sie
                                eine E-Mail-Nachricht mit der eigentlichen Bestätigung einschließlich der
                                Reservierungsnummer.
                                Sie sind jedoch auch dabei, ein Zimmer in unserem Hotel zu buchen, indem Sie sich an
                                unseren
                                Kollegen im
                    ...
                    <div class="accordion-item" id="question2">
                        ...
                        <div class="answer">
                            <p>
                                ...
                                Ihrer
                                Ankunft
                                gehalten wird. Beim Check-in hat man die Möglichkeit, die Buchung in bar oder mit einer
                                anderen
                    ...
                    <div class="accordion-item" id="question3">
                        ...
                        <div class="answer">
                            <p>
                                Der Schutz der Daten unserer Kunden ist uns sehr wichtig. Ihre persönlichen Daten werden
                                durch
                                einen
                    ...
                    <div class="accordion-item" id="question4">
                        ...
                        <div class="answer">
                            <p>
                                ...
                                Wenn Sie vergessen, Ihre Reservierung innerhalb des geforderten Zeitraums zu stornieren,
                                wird
                                Ihnen
                                das
                    ...
                    <div class="accordion-item" id="question5">
                        ...
                        <div class="answer">
                            <p>
                                Sollten Sie innerhalb von 48 Stunden keine Buchungsbestätigung erhalten, bitten wir Sie,
                                sich
                                direkt
                                mit
