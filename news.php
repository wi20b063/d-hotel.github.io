...
<body>
    ...
    <main>   
        <div class="content">
            <div class="container">
                <h1>News-Beiträge</h1>
                <div class="row my-2 border border-1 rounded">
                    <div>
                    ...
                    <div class="row">
                        ...
                        <div class="image col-sm-3 d-flex align-items-sm-center">
                            <img src="res\img\img news\placeholder image.png" alt="news1" class="img-fluid">
                        </div>
                    </div>
                </div>
